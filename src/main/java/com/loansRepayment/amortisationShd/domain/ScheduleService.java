...
public class ScheduleService {
    ...
    public boolean CalculateSchedule(LoanDetailsData loanDetailsData) {
        ...
        try {
            ...
            if (validate(loanDetailsData)) {
                ...
                if (loanDetailsData.getBalloonPayment() == null) {
                    loanDetailsData.setBalloonPayment(BigDecimal.ZERO);
                }
                b = loanDetailsData.getBalloonPayment();
    ...
    private boolean validate(LoanDetailsData loanDetailsData) {
        boolean pass = loanDetailsData.getCostOfAsset() != null && loanDetailsData.getDepositPaid() != null && loanDetailsData.getYearlyInterest() != 0 && loanDetailsData.getNumberOfMonthlyPayments() != null;
